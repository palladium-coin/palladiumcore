...
#ifndef PALLADIUM_PALLADIUM_CONFIG_H
#define PALLADIUM_PALLADIUM_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Palladium Core developers"
...
#endif //PALLADIUM_PALLADIUM_CONFIG_H

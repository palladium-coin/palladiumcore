...
#ifndef PALLADIUM_SCRIPT_SCRIPT_H
#define PALLADIUM_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Palladium always counted CHECKMULTISIGs
...
#endif // PALLADIUM_SCRIPT_SCRIPT_H

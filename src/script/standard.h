...
#ifndef PALLADIUM_SCRIPT_STANDARD_H
#define PALLADIUM_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a palladium address
 */
...
/**
 * Generate a Palladium scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // PALLADIUM_SCRIPT_STANDARD_H

// Copyright (c) 2019-2020 The Palladium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef PALLADIUM_WALLET_SCRIPTPUBKEYMAN_H
#define PALLADIUM_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Palladium Core wallet was originally a collection of unrelated private

// Copyright (c) 2010-2020 The Palladium Core developers
...
void CClientUIInterface::NotifyBlockTip(SynchronizationState s, const CBlockIndex* i, double verification_progress) { return g_ui_signals.NotifyBlockTip(s, i, verification_progress); }

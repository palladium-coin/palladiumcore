...
class CompactBlocksTest(PalladiumTestFramework):
    ...
    # Test that palladiumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for palladiumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # palladiumd will not send blocktxn responses for blocks whose height is

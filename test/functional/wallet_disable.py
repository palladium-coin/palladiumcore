...
class DisableWalletTest (PalladiumTestFramework):
    ...
    def run_test (self):
        ...
        x = self.nodes[0].validateaddress('tAsQFmzM3rydpzYz79EyKtC3kefZPwJ22b')
        assert x['isvalid'] == True

        # Checking mining to an address without a wallet. Generating to a valid address should succeed
        # but generating to an invalid address will fail.
        self.nodes[0].generatetoaddress(1, 'tAsQFmzM3rydpzYz79EyKtC3kefZPwJ22b')

...
class P2PPermissionsTests(PalladiumTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].palladiumconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].palladiumconf, 'w', encoding="utf8") as f:
            f.write(newText)

...
class FullBlockTest(PalladiumTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure palladiumd isn't accepting b26
        ...
        # Extend the b28 chain to make sure palladiumd isn't accepting b28
        ...
        # palladiumd doesn't disconnect us for sending a bloated block, but if we subsequently
    ...
    def _run_palladium_block_scenarios(self, node):
        ...
        #    Low-S and High-S values (whereas the palladium code has custom code which does so);
